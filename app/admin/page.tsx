...
function AdminPage() {
  ...
  const createCashCustomerInvite = async () => {
    ...
    try {
      ...
      setCashCustomerDialog(false); setCashCustomerWantsAccount(true); setSuccessMessage("Client enregistré. L'invitation a été envoyée par e-mail."); setTimeout(() => setSuccessMessage(""), 4000);
